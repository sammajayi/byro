...
const HappeningEvents = () => {
  ...
  return (
    <div className="p-8 bg-blue-600">
      ...
      <div>
        <input type="search" name="event-search" id=""  placeholder="Search for Events"
      ...
      <div className="justify-center text-center mx-auto">
        <Link href="/events">
        <button className="bg-gray-50 text-black font-semibold py-2 px-4 rounded">Load More</button>
        </Link>
      </div>
    </div>
  );
