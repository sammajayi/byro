...
export default function EventDashboard() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 bg-main-section bg-cover bg-center bg-no-repeat z-0" />
      <div className="fixed inset-0 bg-gray-50 z-0 opacity-70" />
      ...
      <div className="relative z-10">
        ...
        <div className="min-h-screen flex flex-col items-center pt-4 sm:pt-6 lg:pt-8 pb-8">
          <main className="bg-white w-full sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%] max-w-6xl rounded-lg p-3 sm:p-4 lg:p-6 shadow-lg">
            {/* Header Section */}
